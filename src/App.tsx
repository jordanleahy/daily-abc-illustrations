...
import PublicDailyPublishedSchedule from "./pages/PublicDailyPublishedSchedule";
    ...
    <HelmetProvider>
      <TooltipProvider>
        ...
        <Routes>
          ...
          <Route path="/public-daily-published-schedule" element={<PublicDailyPublishedSchedule />} />
