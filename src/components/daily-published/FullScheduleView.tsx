...
import { Clock, BookOpen, Image, ArrowLeft } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { DailyPublishedWithBook } from '@/types/dailyPublished';
import { toEasternTime } from '@/utils/timezone';
import { format } from 'date-fns-tz';

// Utility functions (reused from Schedule.tsx)
...
export function FullScheduleView({ onClose }: FullScheduleViewProps) {
  const {
    data: scheduleItems,
    isLoading,
    error
...
// Reusable components (adapted from Schedule.tsx)
