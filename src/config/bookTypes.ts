...
export interface BookType {
  ...
  expectedPageCount?: number; // Total pages including cover + educational focus + content pages
...
export const BOOK_TYPES = [
  {
    ...
    color: 'text-blue-500',
    expectedPageCount: 28, // 26 letter pages + cover + education
  ...
  },
  {
    ...
    expectedPageCount: 12, // 10 number pages + cover + education
    needsClarification: true,
  ...
  },
  {
    ...
    expectedPageCount: 12, // Variable content pages + cover + education (default 12)
    needsClarification: true,
