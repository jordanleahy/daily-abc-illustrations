    ...
    <>
      <MetaHead
        metadata={{
          ...
          description: 'Privacy Policy for Shelly & Thatch - Learn how we collect, use, and protect your data.',
          ...
          <Container size="lg">
            <article className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p>
                  Welcome to Shelly & Thatch, operated by <strong>Van7, LLC</strong> ("Shelly & Thatch," "we," "us," or "our").
              ...
              <section className="mb-8">
                ...
                <p>
                  Shelly & Thatch is designed for <strong>parents, teachers, and caregivers</strong> to provide educational content to children.
