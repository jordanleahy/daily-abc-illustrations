    ...
    <>
      <MetaHead
        metadata={{
          ...
          description: 'Terms of Service for Shelly & Thatch - Legal agreement governing use of our educational platform.',
          ...
          <Container size="lg">
            <article className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p>
                  These Terms of Service ("Terms") are a legally binding agreement between Van7, LLC d/b/a Shelly & Thatch 
                  ("Shelly & Thatch," "Company," "we," "us," or "our") and you ("you," "User") governing your access to and use of
              ...
              <section className="mb-8">
                ...
                <p>
                  Shelly & Thatch is an AI-powered educational platform that helps adults create personalized ABC books and
              ...
              <section className="mb-8">
                ...
                <div className="bg-muted p-6 rounded-lg">
                  <p className="font-semibold">Van7, LLC (DBA Shelly & Thatch)</p>
