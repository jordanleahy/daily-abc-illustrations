...
const PreviewHome = () => {
  ...
  return (
    <PreviewPageLayout>
      ...
      <PreviewSection variant="explainer" id="what-is-shelly-thatch">
      ...
      <DeepDiveSection
        ...
        description="Parents decide the habit. Shelly & Thatch keeps score. Your child earns coins for reading and habit completion, then trades those coins for rewards you approve."
        features={[
      ...
      <DeepDiveSection
        ...
        description="Connect your Shelly & Thatch library and see every book your child explores. Daily AI books appear each morning at 7:01 AM Eastern Time. You choose what stays in rotation and what moves to the side."
        features={[
      ...
      <PreviewSection variant="feature" id="daily-books">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
            Each morning, Shelly & Thatch adds new daily books to your library at 7:01 AM Eastern Time. Use them for quick bedtime reads, morning routines, or screen-time swaps.
          </p>
      ...
      <PreviewSection variant="cta">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            With Shelly & Thatch in your corner
          </p>
          <Button 
            size="lg" 
