...
export interface AgentConfig {
  ...
  type: 'chat' | 'book-creation' | 'book-creation-numbers' | 'book-creation-rhyming' | 'book-creation-colors' | 'book-creation-abc' | 'book-creation-shapes' | 'book-creation-opposites' | 'book-creation-emotions' | 'book-creation-animals' | 'book-creation-first-words' | 'book-creation-bedtime' | 'book-creation-cvc' | 'book-creation-sight-words' | 'book-creation-parent-education' | 'book-creation-manners';
