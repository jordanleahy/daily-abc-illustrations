...
-- Remove old queue management triggers that reference queue positions
DROP TRIGGER IF EXISTS handle_daily_published_queue_insert_trigger ON public.daily_published;
