-- Create test version of daily habit completion function WITHOUT duplicate check
-- This allows unlimited testing by clicking the button multiple times
CREATE OR REPLACE FUNCTION public.test_create_daily_habit_completions()
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  LOOP
    ...
    -- NOTE: NO DUPLICATE CHECK HERE - this is the test version!
    -- This allows creating multiple completions for the same day for testing
