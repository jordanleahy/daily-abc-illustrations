-- Fix search_path security issue for create_scheduled_habit_completions function
-- This sets an explicit search_path to prevent SQL injection vulnerabilities
