-- Update Digraph Agent to use grade levels instead of ages
...
- Page 2: Educational Focus with three badges (Grade Level, Phonics Focus, Digraph Type)
...
Cover prompt format:
"[Character style description]. [Scene description]. CRITICAL INSTRUCTION: Display ''Learning the [DIGRAPH] Sound'' as the main title in large, bold, CENTERED text at the top-center of the cover image, taking up 50-60% of the visual space. Include these 5 example words around the letters: [word1], [word2], [word3], [word4], [word5]. Clean illustration only."
...
1. Grade Level badge (teal background)
