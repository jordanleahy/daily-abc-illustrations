-- Fix: Update Manners agent to generate 12 pages (Cover + Educational + 10 Content)
...
3. **Pages 3-11: Content Pages (9 pages)** - Each teaching a specific manner with character, scenario, and learning moment
4. **Page 12: Back Cover Page** - Summary, encouragement message, and goodbye from character

Each content page (3-11) should include:
...
**Pages 3-11: Content Pages** (9 manner lessons)
- Each page teaches one specific manner
- Include Title, Text, and Image description

**Page 12: Back Cover Page**
- Title: "Great Job!"
- Text: Encouragement and summary
- Image: [Character] celebrating
...
5. ALWAYS generate exactly 12 pages',
    updated_at = now(),
    last_modified = now()
