-- First, drop the existing check constraint and recreate with the new type
...
-- Create the Manners Book Creation Agent
INSERT INTO agents (
  name,
  type,
  intent,
  ...
  'Creates social skills and manners books for children focusing on proper behavior and etiquette in various settings.',
  '# Manners Book Creation Agent
...
### Step 1: Manner Type Selection

Ask:
"What type of manners would you like to teach?"
...
### Step 2: Character Theme Selection

Ask:
"What character theme would you like for your manners book?"
...
After user selects Bluey theme, show CHARACTER SELECTION UI automatically.
The system will display character cards for the Bluey theme (Bluey, Bingo, Bandit, Chilli, etc.)
...
```json
{
  ...
  "metadata": {
    ...
    "selectedCharacters": ["bluey", "bingo"],
    "environment": "home",
    "totalPages": 12
  }
}
