-- Update Rhyming agent to prohibit inventing discovery questions
UPDATE agents 
...
- Maintain consistent art style throughout',
    what_changed = 'Added ZERO INVENTION POLICY to prohibit LLM from inventing discovery questions',
    last_modified = now()
